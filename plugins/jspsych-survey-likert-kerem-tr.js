 ...
 *
 * Josh de Leeuw; modified by Kerem Oktar 4/6/24
 *
    ...
    var modalHTML = `
      <div id="noResponse" class="modal" style="display: none;">
        <div class="modal-content">
          ...
          <p>
          Bu sayfada<b style="color: navy;">bazı soruları cevapsız bıraktınız!</b><br>
          Lütfen devam etmeden önce yanlışlıkla cevaplamadığınız bir soru kalmadığından emin olun.<br>
          Bu uyarı yanlışlıkla soru unutmadığınızdan emin olmak içindir---eğer istemiyorsanız her hangi birini seçmek zorunda değilsiniz.
          </p>
        </div>
      </div>`;
